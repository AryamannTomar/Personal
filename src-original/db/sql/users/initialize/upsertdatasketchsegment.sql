/*
   Create Function UpsertDataSketchSegment for upserting in datasketch_dailyusers, datasketch_segmentstatus tables and also calling the UpsertDataSketchRowFunction. It updates the already existing key, dt, skey and sval pair with theta_sketch_union(new + existing)
*/
...
SELECT create_distributed_function(
  'upsertdatasketchsegment(varchar, text, text, jsonb, varchar, varchar, varchar, varchar)', 'key_input',
);