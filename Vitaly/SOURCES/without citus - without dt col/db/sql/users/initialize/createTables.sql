...
CREATE TABLE IF NOT EXISTS datasketches_segmentstats_${appid:value}(eventkey varchar, skey text, sval theta_sketch);
CREATE UNIQUE INDEX IF NOT EXISTS skey_dt_unique_${appid:value} ON datasketches_segmentstats_${appid:value} (eventkey);
