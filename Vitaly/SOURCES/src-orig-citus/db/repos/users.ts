...
export class UsersRepository {
    ...
    async initializeUpsertDataSketchRow(values: { appid: String }): Promise<null> {
    ...
    async initializeUpsertDataSketchSegment(values: { appid: String }): Promise<null> {
    ...
    async initializeProcessDataSketch(values: { appid: String }): Promise<null> {
