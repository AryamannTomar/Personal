...
import { ActiveUserCount } from './src/models/users/activeusercount';
import { DAU, WAU, MAU } from './src/models/users/types';
...
/* 
    6 Functions(FOR FETCHING O/P) - timeUnits(st_dt, end_dt, app_id, timeUnit) - returns fetched result of postgres query
                                    getResult(arr, app_id, timeUnit)  - returns WAU, MAU
