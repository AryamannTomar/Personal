...
async function getUserCount(st_dt:String, end_dt:String, app_id:String, p=3):Promise<getUserCount>{
    if(p==3){
        var postgresquery:String = `select dt, theta_sketch_get_estimate(usercount) from dailyactiveusers_events_${app_id} where dt BETWEEN '${st_dt}' AND '${end_dt}'`;
    }else{
...
let myresult:any = getUserCount('2021-09-11', '2021-09-29', '5bebe93c25d705690ffbc758');
