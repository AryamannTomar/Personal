...
async function fetch(st_dt, end_dt, app_id, timeUnit, p) {
    if (p == 3) {
...
async function timeUnits(st_dt, end_dt, app_id, timeUnit, p){
    if (timeUnit == 'D') {
...
async function getResult(array, app_id, timeUnit, p){
    let sum = 0;
    var arraynull_final = [];
